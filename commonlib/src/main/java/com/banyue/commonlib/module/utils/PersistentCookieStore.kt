 ...
 */
open class PersistentCookieStore {
    private val LOG_TAG = "PersistentCookieStore"
    private val COOKIE_PREFS = "Cookies_Prefs"

    private var cookies: HashMap<String, HashMap<String, Cookie>>
                ...
                if (encodedCookie != null) {
                    ...
                    if (decodedCookie != null) {
                        if (!cookies.containsKey(key)) {
                            cookies.put(key, HashMap<String, Cookie>())
                        }
    ...
    fun add(url: HttpUrl, cookie: Cookie) {
        ...
        if (!cookie.persistent()) {
            if (!cookies.containsKey(url.host())) {
                cookies.put(url.host(), HashMap<String, Cookie>())
            }
